...
urlpatterns = [
    ...
    path('GaleriaOtras/', GaleriaOtras.as_view(), name='otras'),
    ...
    path('OtrasDetalle/<int:pk>/', OtrasDetalle.as_view(), name='otras'),
    ...
    path('OtrasUpdate/<int:pk>/', OtrasUpdate.as_view(), name='otras_editar'),
